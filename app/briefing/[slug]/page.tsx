...
export async function generateMetadata({params,searchParams}:Props):Promise<Metadata>{
 const {slug}=await params;const lang=resolveLanguage((await searchParams).lang);const b=briefings.find(b=>b.slug===slug);
...
export default async function Page({params,searchParams}:Props){
 ...
 return <Reader briefing={briefing} initialLanguage={resolveLanguage((await searchParams).lang)}/>;
}
